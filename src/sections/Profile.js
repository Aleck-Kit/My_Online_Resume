  ...
  return (
    <div>
      ...
      <ul className="profileLinks text-center">
        <li><a className="fa fa-skype fa-2x" href={'https://twitter.com/'+profileData.profiles[0].username}><span className="sr-only">twitter</span></a></li>
      ...
      <div className="divider"></div>
      <p className="contact-links text-center">Visit my <a href="https://aleck-kitenge-resume-website.netlify.app/">portfolio website</a> </p>
    </div>
  )
};
